...
def card2num (card, A = 11):
    if card == 'J' : value = 10
    elif card == 'Q' : value = 10
    elif card == 'K' : value = 10
    elif card == 'A' : value = A
    else : value = int(card)
    return value
...
def blkjc():
    ...
    while True :
        ...
        while True :
            ...
            if (balance - bet) >= 0 : break
            else : print('>> You bet too much')
        ...
        while True :
            ...
            if card_now == 'A' :
                ...
                else : card_value = card2num(card_now, 11)
            else : card_value = card2num(card_now)
